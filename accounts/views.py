...
class TeacherSignUp(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        teacher = User(username=request.data['username'].strip(), user_type=2, email=request.data['email'], first_name=request.data['first_name'].strip())
...
class StudentSignUp(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        student = User(username=request.data['username'].strip(), user_type=1, email=request.data['email'], first_name=request.data['first_name'].strip())
